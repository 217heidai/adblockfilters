...
def CreatReadme(ruleList, fileName):
    ...
    f.write("## 订阅链接\n")
    f.write("- 原始链接:<https://raw.githubusercontent.com/217heidai/adblockfilters/main/rules/adblockfulters.txt>\n")
    f.write("- 加速链接:<https://ghproxy.com/https://raw.githubusercontent.com/217heidai/adblockfilters/main/rules/adblockfulters.txt>\n")
    f.write("## 规则源\n")
